...
if __name__ == '__main__':
    ...
    for store_id in store_list:
        ...
        sales = pd.read_csv('../TrafficPrediction/StoreDailyTraffic/DailyTraffic_' + str(store_id) + '.csv')
        ...
        '''
        dict_mapes[store_id] = SalesPredictionModel(store_id, sales, fscls, feature_cols, False, flag_model, startmonth_model)
